...
def generate_random_email(length=8):
    ...
    possible_domains = ['@gmail.com', '@hotmail.com', '@yahoo.com', '@example.com']
    return fake.user_name() + random.choice(possible_domains)
...
def main():
    ...
    for _ in range(N):
        ...
        with open('pruebas_seguridad/100_requests_diff_cuentas.csv', 'a') as f:
